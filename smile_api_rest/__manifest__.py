...
Suggestions & Feedback to: Corentin POUHET-BRUNERIE & Julien DRECQ
    ...
    'assets': {
        'smile_api_rest.assets_swagger': [
            'smile_api_rest/static/lib/swagger-ui-5.0.0/swagger-ui.css',
            'smile_api_rest/static/lib/swagger-ui-5.0.0/swagger-ui-bundle.js',
            'smile_api_rest/static/lib/swagger-ui-5.0.0/swagger-ui-standalone-preset.js',
        ],
    },
    "test": [],
    'installable': True,
